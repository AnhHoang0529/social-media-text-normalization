import sys
sys.path.append('/content/drive/MyDrive/NLP/TextNormSeq2Seq/lib')
...
## Data options
parser.add_argument('-traindata', default='/content/drive/MyDrive/NLP/TextNormSeq2Seq/train_data.json', help='Path to train data file')
parser.add_argument('-testdata', default='/content/drive/MyDrive/NLP/TextNormSeq2Seq/test_truth.json',help='Path to the test data file')
...
parser.add_argument('-save_dir',default='/content/drive/MyDrive/NLP/TextNormSeq2Seq', help='Directory to save model checkpoints')
